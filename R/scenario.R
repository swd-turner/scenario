...
#' The \code{\link{buildtree}} function uses the neural gas method to generate a scenario tree of predefined nodal structure.
#' @docType package
#' @name scenario
...
#'
#' # 2. Assign nodal structure for tree:
#'
